...
The `rebar` or `rebar3` automatically will do this for Ubuntu (tested on 14.04 x64). For all other OS's you need to do it manually or adjust the `build_deps.sh`.
